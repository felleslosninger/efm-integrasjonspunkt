...
@Component
public class AdresseRegisterPilotClient implements AdresseRegisterClient {
    ...
    public AdresseRegisterPilotClient() {
    }

    public AdresseRegisterPilotClient(String endPointURL) {
        if (endPointURL == null) {
