...
public class CorrespondenceAgencyMessageFactoryTest {
    ...
    private static final String XML = "<PutMessageRequest xmlns=\"http://www.arkivverket.no/Noark/Exchange/types\">\n"
    ...
    public void initializeJaxb() throws JAXBException, ServiceRegistryLookupException {
        ...
        when(properties.getOrg()).thenReturn(new IntegrasjonspunktProperties.Organization()
                .setNumber("1234")
        );
    ...
    @Test
    public void testFactoryForCDataXML() throws JAXBException {
        EDUCore eduCore = eduCoreFactory.create(createPutMessageCdataXml(XML), "910075918");
        assertFields(correspondenceAgencyMessageFactory.create(eduCore));
    }
    ...
    private void assertFields(InsertCorrespondenceV2 c) {
        ...
        assertEquals("Du har mottatt en melding fra Fylkesmannen i Sogn og Fjordane.", c.getCorrespondence().getNotifications().getValue()
