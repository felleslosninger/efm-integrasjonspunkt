...
public class AvgivendeSystemHandler extends PropertyHandler<Forsendelse.Builder> {
    ...
    public AvgivendeSystemHandler(IntegrasjonspunktProperties integrasjonspunktProperties) {
        super(integrasjonspunktProperties);
    }

    @Override
    public Forsendelse.Builder<Forsendelse> map(Forsendelse.Builder builder) {
