...
public class VirksertClient {
    ...
    VirksertClient(String uri, String scope, String[] rootAliases, String[] intermediateAliases) {
        this(URI.create(uri), scope, rootAliases, intermediateAliases);
    }

    VirksertClient(URI uri, String scope, String[] rootAliases, String[] intermediateAliases) {
        this.uri = uri;

        if (scope != null)
            this.validator = BusinessCertificate.getValidator(scope, rootAliases, intermediateAliases);
    }
