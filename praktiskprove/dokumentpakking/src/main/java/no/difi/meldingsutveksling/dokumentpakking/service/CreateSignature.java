...
public class CreateSignature {
    ...
    public CreateSignature() {
        ...
        try {
            ...
            throw new MeldingsUtvekslingRuntimeException("Kunne ikke initialisere xml-signering", e);
        }
        schema = loadSchema();
    }
    ...
    private Schema loadSchema() {
        try {
            ...
            throw new MeldingsUtvekslingRuntimeException("Kunne ikke laste schema for validering av signatures", e);
    ...
    public Signature createSignature(final Noekkelpar noekkelpar, final List<ByteArrayFile> attachedFiles) {
        ...
        try {
            ...
            throw new MeldingsUtvekslingRuntimeException("Klarte ikke å lese ASiC-E XML for signering", e);
        } catch (XMLSignatureException e) {
            throw new MeldingsUtvekslingRuntimeException("Klarte ikke å signere ASiC-E element.", e);
        }
        ...
        try {
            ...
            throw new MeldingsUtvekslingRuntimeException("Klarte ikke å serialisere XML", e);
        } catch (SAXException e) {
            throw new MeldingsUtvekslingRuntimeException("Kunne ikke validere generert signatures.xml. Sjekk at input er gyldig og at det ikke er ugyldige tegn i filnavn o.l.",
                    e);
        } catch (IOException e) {
    ...
    private XMLSignatureFactory getSignatureFactory() {
        try {
            ...
            throw new MeldingsUtvekslingRuntimeException("Fant ikke XML Digital Signature-provider. Biblioteket avhenger av default Java-provider.");
        }
    }
