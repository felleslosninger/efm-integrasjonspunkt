...
public class CreateManifest {
	...
	public no.difi.meldingsutveksling.dokumentpakking.domain.Manifest createManifest(Organisasjonsnummer avsenderOrg, Organisasjonsnummer mottakerOrg, AsicEAttachable hoveddokument){
