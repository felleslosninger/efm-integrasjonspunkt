...
public class NextMoveMessageMarkers {
    ...
    public static LogstashMarker markerFrom(NextMoveMessage message) {
        ...
        return conversationIdMarker.and(messageIdMarker).and(senderIdMarker).and(receiverMarker).and(messagetypeIdMarker).and(processMarker).and(documentTypeMarker);
    }
