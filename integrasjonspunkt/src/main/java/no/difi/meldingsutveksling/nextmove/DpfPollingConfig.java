...
public class DpfPollingConfig {
    ...
    @Bean
    public SvarInnNextMoveConverter svarInnNextMoveConverter(SvarInnService svarInnService, AsicHandler asicHandler, SBDFactory createSBD, IntegrasjonspunktProperties properties, IntegrasjonspunktNokkel keyInfo) {
        return new SvarInnNextMoveConverter(svarInnService, asicHandler, createSBD, properties, keyInfo);
    }
}
