...
public class NoarkClientFactory {
    ...
    public NoarkClient from(IntegrasjonspunktProperties.NorskArkivstandardSystem properties) throws UnknownArchiveSystemException {
        String noarkType = properties.getType();
        if (noarkType == null) {
