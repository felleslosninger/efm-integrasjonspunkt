...
=== Example 4 - Validation error with extended info

[source,http,role="primary"]
.Response
include::{snippets}/messages/out/create/constraint-validation/http-response.adoc[]

[role="primary"]
.Response fields
[.response-fields]
--
include::{snippets}/messages/out/create/constraint-validation/response-fields.adoc[]
--
