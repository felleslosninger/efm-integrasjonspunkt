...
=== Example 3 - Creating a DPE innsynskrav message
...
=== Example 4 - Creating a DPE publisering message
...
[NOTE]
Please note, that multipart is only allowed for smaller messages.
