...
[plantuml]
....
    participant "Archive System" as fs
...
The service is used to initiate the download of an incoming mmessage.
...
=== Example 2 - Peek incoming DPO message

[source,http,role="primary"]
.Curl
include::{snippets}/messages/in/peek/dpo/curl-request.adoc[]

[source,http,role="secondary"]
.Request
include::{snippets}/messages/in/peek/dpo/http-request.adoc[]

[source,http,role="secondary"]
.Response
include::{snippets}/messages/in/peek/dpo/http-response.adoc[]

=== Example 3 - No more messages

[source,http,role="primary"]
.Curl
include::{snippets}/messages/in/peek/no-content/curl-request.adoc[]

[source,http,role="secondary"]
.Request
include::{snippets}/messages/in/peek/no-content/http-request.adoc[]
...
The service is used to download the ASiC of an incoming mmessage.
...
The service is used to delete an incoming mmessage.
