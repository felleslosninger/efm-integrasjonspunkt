...
The service is used to search for conversations by message ID.
The response is paged with a default page size of 10
...
[source,http,role="primary"]
.Curl
include::{snippets}/conversations/get/not-found/curl-request.adoc[]

[source,http,role="secondary"]
.Request
include::{snippets}/conversations/get/not-found/http-request.adoc[]
...
[source,http,role="primary"]
.Curl
include::{snippets}/conversations/get-by-message-id/not-found/curl-request.adoc[]

[source,http,role="secondary"]
.Request
include::{snippets}/conversations/get-by-message-id/not-found/http-request.adoc[]
