...
public class IntegrasjonspunktImplTest {
    ...
    public void setUp() {
        ...
        when(strategyFactory.hasFactory(ServiceIdentifier.DPI_DIGITAL)).thenReturn(true);
    ...
    public void shouldCheckWithMSHWhenServiceIdentifierIsDPVAndMSHEnabled() {
        when(serviceRegistryLookup.getServiceRecord(IDENTIFIER)).thenReturn(ServiceRecordWrapper.of(ServiceRecordObjectMother.createDPVServiceRecord(IDENTIFIER), Lists.newArrayList(), Maps.newHashMap()));
        enableMsh();
