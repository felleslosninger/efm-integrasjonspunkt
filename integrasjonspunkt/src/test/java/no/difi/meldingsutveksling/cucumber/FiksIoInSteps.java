        ...
        Message message = new Message()
                ...
                .setSbd(new StandardBusinessDocument()
                        .setStandardBusinessDocumentHeader(new StandardBusinessDocumentHeader()
                                .addSender(new Sender().setIdentifier(new PartnerIdentification().setValue("0192:123123123")))
                                .addReceiver(new Receiver().setIdentifier(new PartnerIdentification().setValue("0192:321321321")))
