Feature: Sending a Next Move DPO message of forretningstype avtalt to an extended address
  ...
  Background:
    ...
    And a "GET" request to "http://localhost:9099/identifier/0192:910075918:extended:0/process/urn:no:difi:profile:avtalt:avtalt:ver1.0?securityLevel=3&conversationId=37efbd4c-413d-4e2c-bbc5-257ef4a65a56" will respond with status "200" and the following "application/json" in "/restmocks/identifier/0912-910075918-extended-0-avtalt.json"
    And a "GET" request to "http://localhost:9099/identifier/0192:910075918:extended:0/process/urn:no:difi:profile:avtalt:avtalt:ver1.0?conversationId=37efbd4c-413d-4e2c-bbc5-257ef4a65a56" will respond with status "200" and the following "application/json" in "/restmocks/identifier/0912-910075918-extended-0-avtalt.json"
  ...
  Scenario: As a user I want to send a DPO message with forretningstype avtalt to an extended address
