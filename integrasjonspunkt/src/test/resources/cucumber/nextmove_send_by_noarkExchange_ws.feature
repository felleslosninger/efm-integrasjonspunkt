Feature: Sending a BEST/EDU message by the noarkExchange WebService
  ...
  Background:
    ...
    Given a "GET" request to "http://localhost:9099/identifier/910075918/process/urn:no:difi:profile:arkivmelding:administrasjon:ver5.5" will respond with status "200" and the following "application/json" in "/restmocks/identifier/910075918-administrasjon.json"
    ...
    <arkivmelding xmlns="http://www.arkivverket.no/standarder/noark5/arkivmelding">
        ...
        <mappe xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="saksmappe">
            ...
            <registrering xsi:type="journalpost">
                ...
                <registreringsID>40</registreringsID>
