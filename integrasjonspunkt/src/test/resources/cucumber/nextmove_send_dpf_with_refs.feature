Feature: Sending a Next Move DPF message with sender And receiver refs

  Background:

    Given a "GET" request to "http://localhost:9099/identifier/0192:987464291?securityLevel=3" will respond with status "200" and the following "application/json" in "/restmocks/identifier/987464291.json"
    And a "GET" request to "http://localhost:9099/identifier/0192:910075924?securityLevel=3&conversationId=23efbd4c-413d-4e2c-bbc5-257ef4a65a91" will respond with status "200" and the following "application/json" in "/restmocks/identifier/910075924.json"
    And a "GET" request to "http://localhost:9099/identifier/0192:910075924" will respond with status "200" and the following "application/json" in "/restmocks/identifier/910075924.json"
    And a "GET" request to "http://localhost:9099/identifier/0192:910075924/process/urn:no:difi:profile:arkivmelding:administrasjon:ver1.0?securityLevel=3&conversationId=23efbd4c-413d-4e2c-bbc5-257ef4a65a91" will respond with status "200" and the following "application/json" in "/restmocks/identifier/910075924-administrasjon.json"
    ...
    And a "GET" request to "http://localhost:9099/info/0192:910075924" will respond with status "200" and the following "application/json" in "/restmocks/info/910075924.json"
  ...
  Scenario: As a user I want to send a DPF message with sender And receiver refs
    ...
    """
    {
        "standardBusinessDocumentHeader": {
                ...
                "scope": [
                    {
                        ...
                        "instanceIdentifier": "23efbd4c-413d-4e2c-bbc5-257ef4a65a91",
                        "type": "ConversationId"
                    },
                    {
            ...
            "documentIdentification": {
                ...
                "instanceIdentifier": "abc8849c-e281-4809-8555-7cd54952b936",
    ...
    <sendForsendelseMedId xmlns="http://www.ks.no/svarut/servicesV9">
        <forsendelse>
            ...
            <eksternref>abc8849c-e281-4809-8555-7cd54952b936</eksternref>
            ...
            <svarPaForsendelse>27991054-77b4-48ed-bf9b-ae36bb1b41d1</svarPaForsendelse>
        ...
        <forsendelsesid>ec5e72a3-5772-4bd5-aa33-72094951ca4d</forsendelsesid>
