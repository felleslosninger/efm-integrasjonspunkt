Feature: Sending a Next Move Digital DPV message
  ...
  Background:
    ...
    Given a "GET" request to "http://localhost:9099/identifier/09118532323/process/urn:no:difi:profile:digitalpost:info:ver1.0?securityLevel=3&conversationId=97efbd4c-413d-4e2c-bbc5-257ef4a61212" will respond with status "200" and the following "application/json" in "/restmocks/identifier/09118532323-info.json"
