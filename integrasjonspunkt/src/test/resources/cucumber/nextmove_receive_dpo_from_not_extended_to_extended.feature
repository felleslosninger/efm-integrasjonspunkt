Feature: Receiving a Next Move DPO message from a non-extended address to an extended address

  Background:
    Given a "GET" request to "http://localhost:9099/identifier/0192:910077473?securityLevel=3&conversationId=37efbd6c-413d-4e2c-bbc5-257ef4a65a45" will respond with status "200" and the following "application/json" in "/restmocks/identifier/910077473.json"
    And a "GET" request to "http://localhost:9099/identifier/0192:910077473/process/urn:no:difi:profile:arkivmelding:response:ver1.0?conversationId=37efbd6c-413d-4e2c-bbc5-257ef4a65a45" will respond with status "200" and the following "application/json" in "/restmocks/identifier/910077473-arkivmelding_response.json"
    ...
    """
    {
        "standardBusinessDocumentHeader": {
                ...
                "scope": [
                    {
                        ...
                        "instanceIdentifier": "37efbd6c-413d-4e2c-bbc5-257ef4a65a45",
                        "type": "ConversationId"
                    }
                ]
            },
            "documentIdentification": {
                ...
                "instanceIdentifier": "ff88849c-e281-4809-8556-7cd54952b919",
  ...
  Scenario: As a user I want to receive a DPO message
    ...
    Before the law sits a gatekeeper.
    """
    And the message statuses for the conversation with id = "ff88849c-e281-4809-8556-7cd54952b919" are:
    """
    {
      "content" : [ {
        "id" : 10,
        ...
        "status" : "OPPRETTET",
        "conversationId" : "37efbd6c-413d-4e2c-bbc5-257ef4a65a45",
        "messageId" : "ff88849c-e281-4809-8556-7cd54952b919",
        "convId" : 9
      }, {
        "id" : 11,
        "lastUpdate" : "2019-03-25T12:38:23+01:00",
