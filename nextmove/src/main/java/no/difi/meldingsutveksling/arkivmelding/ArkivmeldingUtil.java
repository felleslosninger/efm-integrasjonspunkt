...
public class ArkivmeldingUtil {
    ...
    public static List<String> getFilenames(Arkivmelding am) throws ArkivmeldingException {
        ...
        Saksmappe saksmappe = am.getMappe().stream()
                ...
                .findAny()
                .orElseThrow(() -> new ArkivmeldingException("Missing instance of 'Saksmappe'"));
        ...
        Journalpost journalpost = saksmappe.getBasisregistrering().stream()
                ...
                .findAny()
                .orElseThrow(() -> new ArkivmeldingException("Missing instance of 'Journalpost"));

        journalpost.getDokumentbeskrivelseAndDokumentobjekt().stream()
