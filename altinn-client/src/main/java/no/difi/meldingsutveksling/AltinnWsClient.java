...
import no.difi.meldingsutveksling.shipping.ws.AltinnReason;
...
public class AltinnWsClient {
    ...
    public static final String CANNOT_DOWNLOAD_FILE = "Cannot download file";
    ...
    private void upload(UploadRequest request, String senderReference) {
        ...
        try {
            ...
            throw new AltinnWsException(FAILED_TO_UPLOAD_A_MESSAGE_TO_ALTINN_BROKER_SERVICE, AltinnReason.from(e), e);
        } catch (IOException e) {
    ...
    public List<FileReference> availableFiles(String partyNumber) {
        ...
        try {
            ...
            throw new AltinnWsException(AVAILABLE_FILES_ERROR_MESSAGE, AltinnReason.from(e), e);
        }
    ...
    public Document download(DownloadRequest request) {
        ...
        try {
            ...
            throw new AltinnWsException(CANNOT_DOWNLOAD_FILE, AltinnReason.from(e), e);
    ...
    private String initiateBrokerService(UploadRequest request) {
        ...
        try {
            ...
            throw new AltinnWsException(FAILED_TO_INITATE_ALTINN_BROKER_SERVICE, AltinnReason.from(e), e);
        }
    }
